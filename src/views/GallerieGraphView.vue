<template>
    <section>
        <div class="p-10 bg-gradient-to-r from-fuchsia-600 to-blue-600">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold leading-tight text-center text-white sm:text-4xl lg:text-5xl">You’ll be in
                    great company</h2>
            </div>
        </div>

        <div class="grid grid-cols-5 md:grid-cols-6 xl:grid-cols-6">
            <div>
            ...
            <div>
                <div class="bg-orange-500 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Floyd Miles
                        </p>
            ...
            <div>
                <div class="bg-blue-500 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Bessie Cooper
                        </p>
            ...
            <div>
                <div class="bg-gray-700 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Annette Black
                        </p>
            ...
            <div>
                <div class="bg-green-400 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Leslie
                            Alexander</p>
            ...
            <div>
                <div class="bg-red-500 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Wade Warren
                        </p>
            ...
            <div>
                <div class="bg-gray-800 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Guy Hawkins
                        </p>
            ...
            <div>
                <div class="bg-indigo-500 aspect-w-1 aspect-h-1">
                    <div class="p-3 sm:p-5 xl:py-6 2xl:py-8 2xl:px-5">
                        <p class="text-sm font-semibold leading-tight text-white sm:text-lg sm:leading-tight">Ralph Edwards
                        </p>
