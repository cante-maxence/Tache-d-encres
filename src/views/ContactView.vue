<template>
    <section class=" my-10 mb- mx-auto bg-gradient-to-br from-blue-100 to-blue-300 animate-pulse sm:py-12 lg:px-24">
        <div class="px-4  sm:px-6 lg:px-8 max-w-7xl">
            <div class="max-w-2xl mx-auto text-center">
                <h2 class="text-3xl font-bold leading-tight pb-6 text-gray-900 sm:text-4xl lg:text-5xl">Contactez moi</h2>
            </div>


            <div class="grid grid-cols-1 gap-4 px-8 text-center md:px-0 md:grid-cols-3">
